  ...
  return (
    <section className="relative bg-gradient-to-br from-primary to-primary/80 py-20 text-primary-foreground overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute right-[15%] top-[30%] animate-float-delayed opacity-10">
          <ToothSparkleIcon size={50} className="text-white" />
        </div>
        <div className="absolute left-[60%] bottom-[20%] animate-float opacity-10 [animation-delay:1s]">
          <ToothIcon size={35} className="text-white" />
        </div>
        <div className="absolute left-[30%] bottom-[15%] animate-tooth-bounce opacity-10">
        ...
        <ScrollReveal animation="scale-in">
          <div className="text-center">
            <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-primary-foreground/10">
              <ToothSparkleIcon size={32} className="text-primary-foreground" />
            </div>
